...
const data = {
    ...
    const Home = {
        ...
        methods:{
            ...
            showAllGenres() {
                this.$root.content = this.products; // Відображення всіх товарів
            },
            filterByGenre(genre) {
                const filteredProducts = this.products.filter(product => product.genre === genre);
                this.$root.content = filteredProducts; // Відображення товарів за вибраним жанром
            },
        ...
        methods:{
            ...
            saveChanges() {
              ...
              handleImageUpload(event) {
                const file = event.target.files[0]; // Отримати перший файл з вибору
            
                if (file) {
                  // Створити об'єкт FileReader для читання файлу
                  const reader = new FileReader();
            
                  // Визначити, що робити, коли файл завантажено
                  reader.onload = (e) => {
                    this.img = e.target.result; // Оновити дані про зображення
                  };
            
                  // Прочитати файл як URL даних (base64)
